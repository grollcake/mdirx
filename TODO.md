...
- [ ] **M1** (2주): 듀얼 패널·기본 FS 작업·키보드 네비게이션, FS actor, ViewModel 기반 (탭은 Phase 4)
...
- [x] 선택: 다중 선택 (Space, Shift+↑/↓, Shift/⌘+클릭) + 전체 선택 토글 (⌥U/⌘A) + Esc 해제 — 0516-1722
- [ ] 선택: 역선택·패턴(글롭/정규식)
...
## Phase 4 — Last (모든 기능 완료 후, PLAN §2)

- [ ] 패널별 독립 탭 (`⌘T`/`⌘W`/`⌃Tab`) + `PaneSnapshot.tabsJSON` 영속화

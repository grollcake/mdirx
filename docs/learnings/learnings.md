...
- [swiftui/file-list-name-width-vs-description-slack.md](swiftui/file-list-name-width-vs-description-slack.md) — 파일리스트 이름 컬럼은 남는 전체 폭이 아니라 rows 최대 이름 실측 폭으로 잡고, 남는 폭은 description 이 흡수해야 ext 가 이름 바로 뒤에 붙는다

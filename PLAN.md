...
ext~description 6개 컬럼은 `HStack(spacing: 2)` 로 타이트하게 묶임. 부모(`..`)와 볼륨은 selection 불가.

| | ▶ (12pt) | 아이콘 (14pt) | 이름 (flex·75%) | ext (52pt) | size (56pt) | date (70pt) | time (36pt) | attrs (36pt) | description (flex·25%) |
|---|---|---|---|---|---|---|---|---|---|
